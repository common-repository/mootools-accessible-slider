...
MooTools Accessible Slider is a WAI-ARIA Enabled Slider Plugin for Wordpress

== Description ==

MooTools Accessible Slider is slider controling the number of your blog's recent posts shown in an
accordion and uses the MooTools WAI-ARIA enabled slider.
